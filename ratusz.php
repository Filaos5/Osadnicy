...
<form id="link_nazwa" action="zdarzenie_cokolwiek.php" method="POST">
    ...
    if($wioska_budynki['gospodarstwo']==0){
        $sql = "SELECT * FROM budowa WHERE wioska=$id_wioski AND budynek='gospodarstwo' AND zrobione=0";
...
document.getElementById("kolejne_przejscie").value = zmiennajava;</script>
    ...
    if($wioska_budynki['tartak']==0){
        $sql = "SELECT * FROM budowa WHERE wioska=$id_wioski AND budynek='tartak' AND zrobione=0";
        if($rezultat = @$polaczenie->query($sql))
{
    $ile_zdarzen = $rezultat->num_rows;
    if($ile_zdarzen==0){
...
document.getElementById("kolejne_przejscie").value = zmiennajava;</script>
    ...
    if($wioska_budynki['kuznia']==0){
        $sql = "SELECT * FROM budowa WHERE wioska=$id_wioski AND budynek='kuznia' AND zrobione=0";
        if($rezultat = @$polaczenie->query($sql))
{
    $ile_zdarzen = $rezultat->num_rows;
    if($ile_zdarzen==0){
...
document.getElementById("kolejne_przejscie").value = zmiennajava;</script>
    ...
    if($wioska_budynki['kosciol']==0){
        $sql = "SELECT * FROM budowa WHERE wioska=$id_wioski AND budynek='kosciol' AND zrobione=0";
        if($rezultat = @$polaczenie->query($sql)){
            $ile_zdarzen = $rezultat->num_rows;
    if($ile_zdarzen==0){
    ?>
...
document.getElementById("kolejne_przejscie").value = zmiennajava;</script>
    ...
    if($wioska_budynki['koszary']==0){
        $sql = "SELECT * FROM budowa WHERE wioska=$id_wioski AND budynek='koszary' AND zrobione=0";
        if($rezultat = @$polaczenie->query($sql))
{
    $ile_zdarzen = $rezultat->num_rows;
    if($ile_zdarzen==0){
...
document.getElementById("kolejne_przejscie").value = zmiennajava;</script>
    ...
    if($wioska_budynki['stajnia']==0 && $wiersz['era']>1){
        $sql = "SELECT * FROM budowa WHERE wioska=$id_wioski AND budynek='stajnia' AND zrobione=0";
        if($rezultat = @$polaczenie->query($sql))
{
    $ile_zdarzen = $rezultat->num_rows;
    if($ile_zdarzen==0){
...
document.getElementById("kolejne_przejscie").value = zmiennajava;</script>
    ...
    if($wioska_budynki['uniwersytet']==0){
        $sql = "SELECT * FROM budowa WHERE wioska=$id_wioski AND budynek='uniwersytet' AND zrobione=0";
        if($rezultat = @$polaczenie->query($sql))
{
    $ile_zdarzen = $rezultat->num_rows;
    if($ile_zdarzen==0){
...
document.getElementById("kolejne_przejscie").value = zmiennajava;</script>
    ...
    if($wioska_budynki['huta']==0 && $wiersz['era']>2){
        $sql = "SELECT * FROM budowa WHERE wioska=$id_wioski AND budynek='huta' AND zrobione=0";
        if($rezultat = @$polaczenie->query($sql))
{
    $ile_zdarzen = $rezultat->num_rows;
    if($ile_zdarzen==0){
    ...
    if($wioska_budynki['fabryka']==0 && $wiersz['era']>2){
        $sql = "SELECT * FROM budowa WHERE wioska=$id_wioski AND budynek='fabryka' AND zrobione=0";
        if($rezultat = @$polaczenie->query($sql))
{
    $ile_zdarzen = $rezultat->num_rows;
    if($ile_zdarzen==0){
...
document.getElementById("kolejne_przejscie").value = zmiennajava;</script>
    ...
    if($wioska_budynki['lotnisko']==0 && $wiersz['era']>3){
        $sql = "SELECT * FROM budowa WHERE wioska=$id_wioski AND budynek='lotnisko' AND zrobione=0";
        if($rezultat = @$polaczenie->query($sql))
{
    $ile_zdarzen = $rezultat->num_rows;
    if($ile_zdarzen==0){
...
document.getElementById("kolejne_przejscie").value = zmiennajava;</script>
    ...
    <?php
        ...
        $sql = "SELECT * FROM budowa WHERE wioska=$id_wioski AND budynek='dom' AND zrobione=0";
        if($rezultat = @$polaczenie->query($sql))
{
    $ile_zdarzen = $rezultat->num_rows;
    if($ile_zdarzen>0){
        ...
        if($rezultat = @$polaczenie->query($sql))
{
    ...
    <div class="m_budowa"> Domy
        ...
        <ul class="koszty_d">
            ...
            <input type="number" name="dom_ilosc"  id='dom' required /></form></li>
        </ul> 
    ...
    <div class="m_budowa"> Bloki
        ...
        <ul class="koszty_d">
            ...
            <input type="number" name="blok_ilosc"  id='blok' required /></form></li>
        </ul> 
    ...
    $ludnosc_zywnosc=200;
    $ludnosc_cena=2000;
    $ludnosc_maksymalna=$wioska_budynki['dom']*5+$wioska_budynki['blok']*200+100;
    $polaczenie->close();
    ?>
    <div class="budynek_zbudowany"> Zbudowane domy <?php echo $wioska_budynki['dom']; ?>
    </div>
