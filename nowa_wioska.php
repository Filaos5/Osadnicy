<?php
   ...
   $sql = "UPDATE wioska SET id_uczestnika='$id_uczestnik_zalogowany', predkosc_zl=20, cywile=20, czas=$czas WHERE mecz='$id_meczu' AND id_uczestnika=0 AND pozycjax=$pozycja_x AND pozycjay=$pozycja_y";
