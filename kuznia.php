...
<script>
    ...
    <div class="container">
    <br>
    <div class="nazwa_budynku"> Kuźnia poziom <?php echo $wioska_budynki['kuznia'] ?> </div>
        <?php
        $drewno=$wiersz_kuznia['drewno'];
        $kamien=$wiersz_kuznia['kamien'];
        $metal=$wiersz_kuznia['metal'];
        $zlotowki=$wiersz_kuznia['pieniadze'];
    if($wioska_budynki['kuznia']==1){
        $zlotowki=$zlotowki*2;
        $drewno=$drewno*2;
    }
    if($wioska_budynki['kuznia']==2){
        $zlotowki=$zlotowki*4;
        $drewno=$drewno*4;
    }
    if($wioska_budynki['kuznia']==3){
        $zlotowki=$zlotowki*8;
        $drewno=$drewno*8;
    }
    if($wioska_budynki['kuznia']==4){
        $zlotowki=$zlotowki*16;
        $drewno=$drewno*16;
    }
    if($wioska_budynki['kuznia']<5){
        ...
        if($rezultat = @$polaczenie->query($sql))
{
  ...
  <div class="budynek_budowa">
        ...
        <a href="budowa/kuznia_rozbudowa.php">
