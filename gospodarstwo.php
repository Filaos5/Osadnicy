...
<script>
    ...
    <div class="container">
    <br>  
        <div class="nazwa_budynku"> Gospodarstwo rolne poziom <?php echo $wioska_budynki['gospodarstwo'] ?> </div>
        <?php
        $drewno=$wiersz_gospoda['drewno'];
        $kamien=$wiersz_gospoda['kamien'];
        $metal=$wiersz_gospoda['metal'];
        $zlotowki=$wiersz_gospoda['pieniadze'];
    if($wioska_budynki['gospodarstwo']==1){
        $zlotowki=$zlotowki*2;
    }
    if($wioska_budynki['gospodarstwo']==2){
        $zlotowki=$zlotowki*4;
    }
    if($wioska_budynki['gospodarstwo']==3){
        $zlotowki=$zlotowki*8;
    }
    if($wioska_budynki['gospodarstwo']==4){
        $zlotowki=$zlotowki*16;
    }
    if($wioska_budynki['gospodarstwo']==5){
        $zlotowki=$zlotowki*32;
    }
    if($wioska_budynki['gospodarstwo']==6){
        $zlotowki=$zlotowki*64;
    }
    if($wioska_budynki['gospodarstwo']==7){
        $zlotowki=$zlotowki*128;
    }
    if($wioska_budynki['gospodarstwo']==8){
        $zlotowki=$zlotowki*256;
    }
    if($wioska_budynki['gospodarstwo']==9){
        $zlotowki=$zlotowki*512;
    }
    if($wioska_budynki['gospodarstwo']<10){
...
document.getElementById("kolejne_przejscie").value = zmiennajava;</script>
   ...
   <?php
    ...
    if($wioska_budynki['gospodarstwo']==10){
        ?>
        <div class="b_podsumowanie"> Maksymalny poziom rozbudowy
        </div> 
        <?php
    }
    $polaczenie->close();
